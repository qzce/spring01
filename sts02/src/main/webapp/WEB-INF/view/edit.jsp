		...
		<div class="col-md-8">
			...
			<input type="hidden" name="num" value="${bean.num }"/>
			  <div class="form-group">
			    <label for="sub" for="inputEmail3" class="col-sm-2 control-label">제목</label>
			    <div class="col-sm-10">
			      <input type="text" class="form-control" name="sub" id="sub" value="${bean.sub }"/>
			    </div>
			  </div>
			  <div class="form-group">
			    <label for="name" for="inputEmail3" class="col-sm-2 control-label">글쓴이</label>
			    <div class="col-sm-10">
			  ...
			  <div class="form-group">
			    <div class="col-sm-offset-2 col-sm-5">
			      <button type="submit" class="btn btn-primary btn-block" role="button">수정</button>
			    </div>
			    <div class="col-sm-5">
