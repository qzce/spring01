...
public class Day02Dao2 implements Day02Dao {
	...
	public Day02Vo selectOne(int num) {
		...
		return (Day02Vo) jdbcTemplate.queryForObject(sql,mapper, new Object[] {num});
	}
	...
	public int updateOne(Day02Vo bean) {
		...
		return jdbcTemplate.update(sql, new Object[] {bean.getSub(), bean.getName(), bean.getContent(), bean.getNum()});
	}
